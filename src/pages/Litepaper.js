      ...
      <div id="Litepaper" className="container-fluid ">
         <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12 text-left p-0">
               ...
               To unveil a batch of 2,000 PFP-style Community Founders Passes aimed at boosting funding for the project, 
               and creating a buzz in the community. Our belief is that individuals will back our extensive collection of 
               interconnected NFTs designed for the alternate reality game "The Lost Ones" and our future metaverse through 
               the acquisition of this collection. Our team is committed to providing outstanding art and practicality, 
               ...
               <br/>
               All “Hbarbarians” Community Founders Passes will be playable as the Mortals race in the upcoming ARG (Alternate Reality Game).
               <br/>
               All holders will receive a free NFT airdrop from a collection curated by our very own in-house artist @alixonjviloria.
               <br/>
               One whitelist will be granted for each of the 5 ARG NFT collections that are to be dropped in the future. There is zero obligation to use these, they are there simply if you want or need them.
               <br/>
               One “Hbarbarian” Community Founders Pass holder will be deemed an instant winner of the ARG, guaranteeing that the individual who possesses it will receive his or her share of the prize pool at the end of the game.
               <br/>
               ...
               future characters to follow the clues to determine which are usable game pieces. However, holders of the "Hbarbarian" Community Founder Passes
                will have no need for this initial problem-solving to determine which ones can or cannot be played with - a clear advantage for those who possess this collection.
