         ...
         <div className="row">
            ...
            <div className="col-sm-12 col-md-12 col-lg-12 text-center p-0">
               ...
               <p className="para_p  ">
                  ...
                  <p className="para_p">
                  Abuse of the term “Community Founders Passes”, a lack of transparency surrounding what is being built and/or worked on, the absence of a fully doxed team, and an overall lack of depth and utility surrounding certain collections are all issues that are not unique to the Hedera Digital Collectibles space. In fact, it could be argued that these problems are far more common within other Digital Collectibles ecosystems outside of Hedera, however, they are still very much present to a certain extent on our own home turf.
                  <br/><br/>
                  </p>
