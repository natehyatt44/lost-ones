         ...
         <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12 text-left p-0">
               ...
               <p className="para_p  ">MISSION STATEMENT <br/><br/>
                  To create a community-driven ecosystem of NFT collections under the umbrella of BarbarianInc, which is a special and unique NFT company catering to the larger crypto space as a whole. Our main goal is to establish ourselves as a brand upon which trust and value can come to be expected. Secondary to this, but still of massive importance to the team, we hope that this attitude and outlook will catch the attention of collectors not just within Hedera, but also with collectors from many other ecosystems outside of Hedera as well, acting as a catalyst to help grow the user base of Hedera itself.
                  <br/><br/>
                  THE PROBLEM AS WE SEE IT <br/><br/>
                  Abuse of the term “Community Founders Passes”, a lack of transparency surrounding what is being built and/or worked on, the absence of a fully doxed team, and an overall lack of depth and utility surrounding certain collections are all issues that are not unique to the Hedera NFT space. In fact, it could be argued that these problems are far more common within other NFT ecosystems outside of Hedera, however, they are still very much present to a certain extent on our own home turf.
                  <br/><br/>
                  THE SOLUTION AS WE SEE IT <br/><br/>
                  Provide outstanding real-world utility to all our collections. Anything released under the umbrella of BarbarianInc will have its own unique purpose and place within our ecosystem. Everything we build will be of the highest quality in terms of art, with extreme attention to detail being paid at every turn. Finally, dispelling the unfavorable views people have in regard to Community Founders Passes will be accomplished through tethering maximum functionality to our own CFPs, while simultaneously providing fully transparent and ongoing updates as new use cases arise for these.
                  <br/><br/>
                  VALUE PROP FOR THE COLLECTIONS WITHIN THE BARBARIANINC ECOSYSTEM <br/><br/>
                  At BarbarianInc we aim to build value from the ground up, one collection at a time. By coupling timeless art and a plethora of announced holder benefits in conjunction with the release of our “Hbarbarians” Community Founders Passes, this will very much set the stage for what comes next, our Alternate Reality Game (ARG). We will then launch and roll out our 5 subsequent NFT collections associate with our ARG, which will offer a thrilling and rewarding experience for the community. Proceeding from this point, it starts to become clear that expectations surrounding quality and value in anything relating to BarbarianInc will be running at all-time highs. This will benefit holders most, as the perceived value of anything pertaining to our NFT ecosystem will also be running at all-time highs. Keeping up and maintaining this momentum will be our utmost priority. It is in this way that we will build and maintain value within our company, through actually delivering.
                  <br/><br/>
                  FUNDING <br/><br/>
                  ...
                  <br/><br/><br/>
                  MEET THE TEAM <br/><br/>
                  Jesse Landman aka <a href="https://twitter.com/matadorvsmoose">@matadorvsmoose</a> <br/>
                  Community Manager/Story & Lore Writer <br/>
                  With a lifelong passion for both art and technology, Poncho found his place in the web 3 community in late 2020. 
                  He excels as a community builder and possesses a strong entrepreneurial drive. Although drawn to the technology originally, it was the 
                  supportive and vibrant community that made him stay.<br/><br/>
                  Alixon Viloria aka <a href="https://twitter.com/alixonjviloria">@alixonjviloria</a> <br/>
                  Artist <br/>
                  ...
                  Nate Hyatt aka <a href="https://twitter.com/nbreezay4">@nbreezay4</a> <br/>
                  Lead Developer <br/>
                  ...
                  Justin Bratt aka <a href="https://twitter.com/jmjustinmyers">@jmjustinmyers</a> <br/>
                  CEO/Project Coordinator <br/>
