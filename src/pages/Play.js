...
const text = `Destroyed by their own hand, the Mortal's home planet of Earth died many eons ago. 
              ...
              is also a healthy dose of ultraviolent protectionism of what they now hold most dear... each other. Finally, 
              intergalactic travel was accomplished, and over time, many members of this race have elected to migrate throughout the universe.`;
      ...
      >
        ...
        <Modal.Footer className='hashpack-modal-footer'>
          ...
          <Button variant="dark" onClick={async () => {
            ...
            const nfts = await AccountNFTs(accid)
            nfts.push(4,90,133, 149, 155, 961, 900)
            setNfts(nfts)
          }}>
                Copy Pairing String
          </Button>
        ...
        {isImageSelected && (
          ...
          <div className="row">
              <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center lore-item">
                  <Slide direction='down' duration={10000}><h1 className="h1_head_sml set_font"> Chapter 1 </h1></Slide>
              </div>
            </div>
            <div className="row">
